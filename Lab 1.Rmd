...
joined_table <- democracy_df %>%
  left_join(gdp_df, by = c("Country" = "Country")) %>%
  left_join(population_df, by = c("Country" = "Country")) %>%
  left_join(incarceration_df, by = c("Country" = "Country")) %>%
  left_join(area_df, by = c("Country" = "Country"))
