...
max_value <- countries %>% select( colnames(countries)[which(x <= "X2022" & x >= "X2006")]) %>% apply( 1, max)
 min_value <- countries %>% select( colnames(countries)[which(x <= "X2022" & x >= "X2006")]) %>% apply( 1, min)
